...
void CostTable::CheckTableCells(const funcCostTable func, const int16_t note1, const int16_t note2)
{
...
# endif
void CostTable::CheckAllTableCells(const funcCostTable func, const int16_t randNote)
{
# ifdef _DEBUG
